  ...
  <header class="article-header">
	...
	<div class="article-meta"> 
		<span class="item article-meta-time">
	  	...
	  	<span class="item article-meta-source" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="来源：【今日热点】">
	  	...
	  	<span class="item article-meta-views" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="历史浏览量：${news.viewNumber }">
	  		<i class="glyphicon glyphicon-eye-open"></i> ${news.viewNumber }
	  	</span> 
	  	<span class="item article-meta-comment" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="历史评论量${news.commentNumber }">
			...
			success:function(data){
				if(data.type == 'success'){
					...
					if(commentList.length == 0){
						$("#load-more-comment-btn").text('我是有底线的!');
