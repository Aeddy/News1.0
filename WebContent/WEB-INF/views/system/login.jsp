...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  <title>"今日热点新闻"后台管理员登录</title>
  <meta name="description" content="particles.js is a lightweight JavaScript library for creating particles.">
  <meta name="author" content="Vincent Garreau">
  <meta name="viewport" content="width=device-width, initial-scale=1.0, minimum-scale=1.0, maximum-scale=1.0, user-scalable=no">
  <link rel="stylesheet" media="screen" href="../resources/admin/login/css/style2.css">
...
var current = index + 1;
document.getElementById('img1').src="../resources/admin/login/images/meitu/"+current + ".jpg";
index++;
...
<img src="../resources/admin/login/images/meitu/good2.png" alt="" width="100%" height="100%" >
<div id="particles-js">
		<div class="login" style="display: block;">
			...
			<div class="login-center clearfix">
				...
				<div class="login-center-input">
					<input style="width:50%;" type="text" name="cpacha" id="cpacha" value="" placeholder="请输入验证码" onfocus="this.placeholder=&#39;&#39;" onblur="this.placeholder=&#39;请您输入验证码&#39;">
					<div class="login-center-input-text">验证码:</div>
					<img id="cpacha-img" title="清楚否？点击更换验证码" style="cursor:pointer;" src="get_cpacha?vl=4&w=150&h=40&type=loginCpacha" width="110px" height="30px" onclick="changeCpacha()">
				</div>
			</div>
