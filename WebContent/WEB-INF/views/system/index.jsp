...
<meta name="copyright" content="All Rights Reserved, Copyright (C) 2019, 今日热点, Ltd." />
<title>今日热点新闻后台管理</title>
...
<div id="loading" style="position:absolute;z-index:1000;top:0px;left:0px;width:100%;height:100%;background:#FFFFFF;text-align :center;padding-top:6%;">
     <img src="../resources/admin/easyui/images/loading6.gif" width="50%">
</div> 
	<!-- begin of header -->
    ...
    <!-- end of header -->
    <!-- begin of sidebar -->
	<div class="wu-sidebar" data-options="region:'west',split:true,border:true,title:'功能菜单导航'"> 
	...
	<div class="wu-footer" data-options="region:'south',border:true,split:true">
    	&copy; 2019 【今日热点】 All Rights Reserved
    </div>
    <!-- end of footer -->  
